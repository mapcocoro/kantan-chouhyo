        ...
        <table className="min-w-full text-xs border border-slate-300">
          <thead className="bg-slate-50">
            <tr>
              ...
              <th className="px-2 py-1 text-left border-b border-slate-300 w-40">品名・作業内容</th>
              <th className="px-2 py-1 text-left border-b border-slate-300 w-32">摘要</th>
          ...
          <tbody>
            {items.map((item, index) => (
              <tr key={index} className="border-b border-slate-200">
                ...
                <td className="px-2 py-1">
                  <select
                    className="w-16 text-sm leading-6 px-1 py-1 h-9 rounded border border-slate-300 bg-white focus:outline-none focus:ring-1 focus:ring-sky-300 focus:border-sky-300 text-center"
                    value={item.unit || '式'}
